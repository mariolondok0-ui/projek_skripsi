...
.modern-modal-body .form-control:focus { 
    background-color: #ffffff; border-color: #dc2626; 
...
.btn-modal-simpan:hover { background: #b91c1c; transform: translateY(-1px); box-shadow: 0 6px 8px -1px rgba(220,38,38,0.4); }
</style>
</head>
<body>
...
<div class="admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="page-header" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px;">
      <div>
        <h1 class="page-title"><i class="fas fa-arrow-circle-down" style="color:var(--danger)"></i> Kas Keluar</h1>
        <p class="page-subtitle" style="color:#0f172a; font-weight:600;">Kelola data pengeluaran kas Masjid Baeturrohman</p>
      </div>
    ...
    <div class="summary-bar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:16px">
      <div style="display:flex;gap:12px;flex-wrap:wrap">
        <div class="summary-bar-item" style="background:var(--bg-card);padding:12px 18px;border-radius:var(--radius);box-shadow:var(--shadow-sm);display:flex;align-items:center;gap:10px;border-left:3px solid var(--danger)">
          <i class="fas fa-arrow-down" style="color:var(--danger);font-size:1.1rem"></i>
    ...
    <div class="table-wrapper animate-fadeIn table-wrapper-desktop">
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr><td colspan="6"><div class="empty-state"><div class="es-icon"><i class="fas fa-inbox"></i></div><h3>Belum ada data kas keluar</h3><p>Klik tombol "Tambah Data" di atas untuk menambahkan data baru.</p></div></td></tr>
          <?php endif; ?>
        </tbody>
  ...
  <div class="modern-modal-box">
    <div class="modern-modal-header">
      <div class="modern-modal-title">
        <i class="fas fa-plus-circle"></i> Tambah Kas Keluar Baru
      </div>
...
<div class="modern-modal-overlay" id="editModal">
  <div class="modern-modal-box">
    <div class="modern-modal-header">
      <div class="modern-modal-title">
        <i class="fas fa-edit"></i> Edit Data Kas Keluar
      </div>
