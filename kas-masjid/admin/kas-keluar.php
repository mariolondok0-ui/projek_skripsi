    ...
    <div class="card mb-3 animate-fadeIn">
      <div class="card-header">
        <div class="card-title">
          ...
          <?= $edit_data ? 'Edit Data Kas Keluar' : 'Tambah Kas Keluar' ?>
        </div>
        <?php if ($edit_data): ?>
        <a href="kas-keluar.php" class="btn btn-ghost btn-sm"><i class="fas fa-times"></i> Batal Edit</a>
        <?php endif; ?>
      </div>
      <div class="card-body">
        <form method="POST">
    ...
    <div class="summary-bar" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:16px">
      <div style="display:flex;gap:12px;flex-wrap:wrap">
        <div class="summary-bar-item" style="background:var(--bg-card);padding:12px 18px;border-radius:var(--radius);box-shadow:var(--shadow-sm);display:flex;align-items:center;gap:10px;border-left:3px solid var(--danger)">
          <i class="fas fa-arrow-up" style="color:var(--danger);font-size:1.1rem"></i>
          <div><div style="font-size:.7rem;color:var(--text-muted)">Total Pengeluaran Bulan Ini</div>
