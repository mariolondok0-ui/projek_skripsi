...
<aside class="sidebar" id="adminSidebar">
  <div class="sidebar-header">
    <div class="sidebar-logo" style="background:none;padding:0;box-shadow:none;overflow:hidden">
      <img src="<?= APP_URL ?>/assets/img/logo.jpg" alt="Logo Masjid"
           style="width:44px;height:44px;object-fit:cover;border-radius:10px;display:block">
    </div>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= APP_URL ?>/admin/profil.php"
      ...
      <span class="nav-icon"><i class="fas fa-user-cog"></i></span> Profil Admin
    </a>
